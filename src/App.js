...
export default function App() {
  const [message, setMessage] = useState(
    "Hola amor, ¿quieres ser mi San Valentín? 💖"
  );
  ...
  const handleYesClick = () => {
    setMessage(
      "¡SIIII! Sabía que ibas a querer, mi amor. Te amo con todo mi ser ❤️ Nos vemos mañana a la noche, piensa en una buena peli y ponte linda (como siempre estás) 😍"
    );
